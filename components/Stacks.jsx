...
const Stacks = () => (
  <main className="flex h-full w-full">
    <section aria-labelledby="tech-stacks-heading">
      <h2 id="tech-stacks-heading" className="sr-only">
        Technical Skills
      </h2>
      <div className="grid h-full w-full grid-cols-2 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 rounded-lg border-1 border-gray-700 bg-[var(--background)] p-4">
