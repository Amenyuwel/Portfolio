...
const LandingPage = () => {
  ...
  const structuredData = {
    ...
    description:
      "Full-Stack Web & Mobile Developer with a Bachelor's degree in Computer Science. Building scalable and user-friendly web and mobile applications.",
    ...
    <>
      ...
      <main className="relative flex h-screen w-full flex-col items-center">
        ...
        <section className="flex h-screen w-full flex-col items-center justify-center px-4">
          <article className="flex h-auto w-full max-w-full flex-col rounded-lg border-2 border-[var(--opposite)] bg-[var(--background)] p-4 text-xl font-bold shadow-xl backdrop-blur-sm md:p-6 lg:w-[70%] lg:p-8 xl:w-[50%]">
            {/* Name and Links */}
                ...
                <section className="xsm:text-center mb-4 w-full sm:text-center md:mb-6 md:text-left">
                  <p className="font-body xsm:justify-center flex items-center justify-center text-lg text-[var(--text-main)] sm:justify-center md:justify-start md:text-xl lg:text-2xl">
                    <MapPinIcon
                      ...
                      aria-hidden="true"
                    />
                    <span className="text-[var(--text-secondary)] sm:font-normal">
            ...
            <section className="mb-2 w-full">
              <h2 className="text- text-xl leading-relaxed font-normal text-pretty text-[var(--text-main)] md:text-2xl lg:text-3xl">
                Full-Stack Web & Mobile Developer, with a Bachelor's degree in
                Computer Science. Building scalable and user-friendly web and
                mobile applications.
              </h2>
            </section>
          </article>
