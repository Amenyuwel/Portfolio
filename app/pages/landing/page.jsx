  ...
  return (
    <main className="flex h-screen w-full flex-col items-center bg-[var(--background)]">
      <section className="flex h-screen w-[45%] flex-col items-center bg-[var(--background)]">
        <article className="bg-main mt-16 flex h-auto w-full flex-col rounded-lg border-2 border-gray-700 p-8 text-3xl font-bold shadow-lg">
          {/* Name and Links */}
          <header className="mb-4 flex w-full items-center justify-between">
            <h1 className="font-heading text-main text-5xl">
