...
const LandingPage = () => {
  ...
  <article className="flex h-auto w-full max-w-full flex-col rounded-lg border-2 border-[var(--opposite)] bg-[var(--background)] p-4 text-xl font-bold shadow-xl backdrop-blur-sm md:p-6 lg:w-[70%] xl:w-[50%] lg:p-8">
          {/* Name and Links */}
